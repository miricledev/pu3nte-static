...
function getSpecialCourses(): SpecialCourse[] {
  return [
    ...
    },
    {
      ...
      label: "Cuban Spanish",
      family: "spanish-dialect",
      variety: "Cuban Spanish",
      learnerNativeLanguage: "english",
      targetLanguage: "spanish",
      narratorEnv: "ELEVENLABS_ENGLISH_NARRATOR_VOICE_ID",
      maleVoiceEnv: "ELEVENLABS_CUBAN_SPANISH_MALE_VOICE_ID",
      femaleVoiceEnv: "ELEVENLABS_CUBAN_SPANISH_FEMALE_VOICE_ID",
      researchFocus: "Cuban everyday speech in the selected context: Caribbean discourse markers, idioms, register shifts, social subtext, humour, fast natural rhythm, informal reductions, and useful local phrasing beyond the obvious starter-pack expressions.",
      culturalGuardrails: "Teach Cuban Spanish with context and respect. Avoid caricaturing pronunciation, reducing Cuba to politics, or making every line exaggerated slang.",
    },
    {
      id: "andalusian-spanish",
      label: "Andalusian Spanish",
      family: "spanish-dialect",
      variety: "Andalusian Spanish",
      learnerNativeLanguage: "english",
      targetLanguage: "spanish",
      narratorEnv: "ELEVENLABS_ENGLISH_NARRATOR_VOICE_ID",
      maleVoiceEnv: "ELEVENLABS_ANDALUSIAN_SPANISH_MALE_VOICE_ID",
      femaleVoiceEnv: "ELEVENLABS_ANDALUSIAN_SPANISH_FEMALE_VOICE_ID",
      researchFocus: "Andalusian everyday speech in the selected context: local discourse markers, informal reductions, seseo/ceceo awareness where useful, usted/ustedes variation, humour, tapas/bar culture, feria/Semana Santa social language, coastal/inland lifestyle, and useful local phrasing beyond the obvious starter-pack expressions.",
    ...
    },
    {
      ...
      family: "spanish-dialect",
      variety: "Puerto Rican Spanish",
      learnerNativeLanguage: "english",
      targetLanguage: "spanish",
      narratorEnv: "ELEVENLABS_ENGLISH_NARRATOR_VOICE_ID",
      maleVoiceEnv: "ELEVENLABS_PUERTO_RICAN_SPANISH_MALE_VOICE_ID",
      femaleVoiceEnv: "ELEVENLABS_PUERTO_RICAN_SPANISH_FEMALE_VOICE_ID",
      researchFocus: "Puerto Rican everyday speech in the selected context: Caribbean discourse markers, informal reductions, Spanglish/contact-language awareness where natural, reggaetón/salsa/social life, chinchorreo, fiestas patronales, family and diaspora contexts, and useful local phrasing beyond the obvious starter-pack expressions.",
      culturalGuardrails: "Teach Puerto Rican Spanish with context and respect. Avoid caricaturing pronunciation, reducing the island to party clichés, or forcing Spanglish where it does not fit.",
    },
    {
      id: "british-english",
...
function getSpecialCourseTopics(): SpecialCourseTopic[] {
  ...
  const gen3ByCourse: Record<string, Record<SpecialCourseLevel, Array<[string, string]>>> = {
    "colombian-spanish": {
      B1: [
        ...
        ["Ciclovía Sunday plans in Bogotá", "Make easy plans around Ciclovía, meeting points, bikes, timing, and weather."],
        ["Finding your way on TransMilenio", "Ask for stations, routes, crowds, delays, and where to get off in simple local Spanish."],
        ["A family lunch with ajiaco or bandeja paisa", "Talk about Colombian family meals, portions, preferences, and polite reactions."],
        ["Día de las Velitas with neighbours", "Use simple invitations, candles, street greetings, and warm community phrases."],
        ["Buying fruit at a plaza de mercado", "Ask prices, quantities, recommendations, and react to local fruit names naturally."],
        ["Going to a fútbol match with friends", "Build phrases for tickets, meeting up, team talk, crowds, and celebrations."],
        ["Coffee farm visit in the Eje Cafetero", "Talk about coffee, farms, tours, taste, weather, and simple travel questions."],
        ["Rainy afternoon plans in Bogotá", "Explain rain, delays, transport changes, and low-key indoor plans."],
        ["Salsa night in Cali for beginners", "Make simple plans, say you can or cannot dance, and react to music and nerves."],
      ],
      B2: [
        ["Barranquilla Carnival plans and crowd logistics", "Discuss parade plans, costumes, timing, safety, and changing plans in local speech."],
        ["Medellín Feria de las Flores weekend", "Tell a story about flowers, events, traffic, photos, and meeting friends."],
        ["Explaining regional food without sounding touristy", "Compare Colombian dishes, explain preferences, and recommend food naturally."],
        ["Coffee culture beyond just ordering tinto", "Talk about coffee quality, farms, cafés, taste, and everyday coffee habits."],
        ["Caribbean coast beach trip with friends", "Negotiate plans, transport, heat, food, music, and group expectations."],
        ["Costeño versus rolo communication styles", "Discuss regional tone, speed, humour, and misunderstandings respectfully."],
        ["Navigating a Colombian family gathering", "Handle greetings, food pressure, teasing, and polite exits at a family event."],
        ["Apartment hunting in Bogotá or Medellín", "Ask about neighbourhoods, security, transport, noise, rent, and practical concerns."],
        ["A vallenato night that turns emotional", "React to music, nostalgia, dedications, and friendship moments with Colombian tone."],
        ["Street vendor negotiation without being rude", "Ask prices, bargain softly, decline politely, and keep the mood friendly."],
      ],
      C1: [
        ["Reading class and region in Colombian speech", "Discuss how accent, neighbourhood, education, and region affect perception and tone."],
        ["Talking about security without sounding paranoid", "Handle nuanced conversations about safety, risk, trust, and local advice."],
        ["Political tension at a Colombian dinner table", "Disagree tactfully, avoid escalation, and read when humour is too risky."],
        ["Regional pride without stereotyping Colombia", "Talk about paisas, costeños, rolos, caleños, and llaneros with nuance."],
        ["When Colombian friendliness is real or just polite", "Interpret warmth, indirect refusal, invitations, and social ambiguity."],
        ["Professional networking over coffee in Bogotá", "Build rapport, soften asks, discuss opportunities, and avoid sounding transactional."],
        ["Handling teasing about your Spanish in Colombia", "Respond to jokes, corrections, praise, and social pressure with confidence."],
        ["Talking about money discreetly in social plans", "Navigate splitting costs, invitations, generosity, and embarrassment tactfully."],
        ["Cali salsa social codes", "Read invitations to dance, respect boundaries, joke lightly, and leave gracefully."],
        ["Explaining foreignness without becoming the centre", "Talk about being an outsider, belonging, mistakes, and cultural learning humbly."],
      ],
      C2: [
        ["Debating Colombia's regional identities with tact", "Handle layered views on identity, class, race, geography, and belonging without flattening people."],
        ["Subtext in Colombian politeness and soft refusals", "Decode indirect no, delayed replies, warm excuses, and face-saving phrasing."],
        ["Conflict repair after a family or group slight", "Apologise, de-escalate, restore warmth, and avoid making the conflict public."],
        ["Colombian humour under social pressure", "Use irony, teasing, and understatement while reading when the joke stops being safe."],
        ["Discussing migration and return with emotional precision", "Talk about leaving, returning, nostalgia, opportunity, and family pressure."],
        ["Elite, popular, and regional register shifts", "Switch tone across professional, family, neighbourhood, and party contexts."],
        ["A delicate conversation about safety and privilege", "Speak honestly about risk and privilege without sounding preachy or naive."],
        ["Persuading a Colombian client without overselling", "Use mature local phrasing for trust, value, uncertainty, and next steps."],
        ["Navigating a tense Colombian group chat", "Interpret indirect digs, silence, reactions, alliances, and repair moves."],
        ["Cultural storytelling with Colombian rhythm", "Tell a reflective story using local pacing, humour, emotion, and regional detail."],
      ],
    },
    "argentinian-spanish": {
      B1: [
        ["Sharing mate for the first time", "Build simple phrases for offering, accepting, refusing, and reacting to mate."],
        ["Ordering medialunas at a café", "Ask for pastries, coffee, prices, seating, and simple preferences."],
        ["Taking the subte and colectivos in Buenos Aires", "Ask routes, stops, delays, cards, and directions using local transport words."],
        ["Planning an asado with friends", "Talk about food, timing, who brings what, and simple invitations."],
        ["Going to a football match watch-party", "Use simple reactions, team talk, snacks, and celebration phrases."],
        ["Buying at a kiosco late at night", "Ask for snacks, phone credit, prices, and quick recommendations."],
        ["A rainy day in Buenos Aires", "Explain weather, transport problems, changed plans, and arrival updates."],
        ["Weekend plan in a plaza or park", "Make relaxed plans, suggest times, and talk about mate, music, and friends."],
        ["Family Sunday pasta lunch", "Talk about family food, portions, compliments, and polite refusals."],
        ["Simple small talk about tango and music", "Say what music you like, ask about tango, and react naturally."],
      ],
      B2: [
        ["Asado logistics and friendly pressure", "Negotiate what to bring, timing, dietary preferences, and group expectations."],
        ["Mate etiquette and social signals", "Explain turns, sharing, refusing politely, and what the ritual means socially."],
        ["Buenos Aires café conversation", "Talk about work, study, stress, prices, and neighbourhood life at a café."],
        ["Football rivalry without going too far", "React to teasing, rivalry, match drama, and passionate disagreement."],
        ["Inflation and everyday money talk", "Discuss prices, budgets, going out, and cost complaints without sounding formal."],
        ["Planning a Patagonia trip with friends", "Handle costs, weather, distances, packing, and realistic expectations."],
        ["Explaining voseo to a visitor", "Describe vos forms, tone, familiarity, and when they sound natural."],
        ["Boliche plans and late-night timing", "Coordinate late plans, arrivals, entry, excuses, and group changes."],
        ["Neighbourhood identity in Buenos Aires", "Compare barrios, vibes, transport, safety, food, and social impressions."],
        ["A family debate over politics or football", "Soften disagreement, joke, redirect, and avoid ruining the lunch."],
      ],
      C1: [
        ["Argentinian irony at a café table", "Read sarcasm, affectionate complaint, exaggeration, and indirect criticism."],
        ["Class, neighbourhood, and accent in Buenos Aires", "Discuss social signals, register, and perception without stereotyping."],
        ["When chamuyo is charming or too much", "Interpret persuasion, flirtation, exaggeration, and social boundaries."],
        ["Asado as social negotiation", "Navigate roles, hierarchy, teasing, and unspoken rules around the grill."],
        ["Discussing money during economic uncertainty", "Talk about inflation, anxiety, jokes, resignation, and practical decisions."],
        ["Football identity and emotional restraint", "Handle intense loyalty, rivalry, loss, teasing, and group tension."],
        ["Tango, nostalgia, and city identity", "Speak about tradition, melancholy, pride, and performance with nuance."],
        ["Calling out someone who is vendiendo humo", "Challenge hype, vagueness, and empty promises without sounding aggressive."],
        ["Friend-group plans that never fully close", "Handle ambiguity, last-minute changes, and soft commitment in local style."],
        ["Reading indirect criticism in Argentinian banter", "Notice palitos, humour, tension, and the moment to bajá un cambio."],
      ],
      C2: [
        ["High-level persuasion over an asado table", "Use humour, evidence, concessions, and social timing to persuade without selling humo."],
        ["Subtext in Argentinian disagreement", "Decode irony, understatement, loaded pauses, and indirect attacks."],
        ["Identity, crisis, and pride in conversation", "Discuss national pride, frustration, exile, return, and resilience with precision."],
        ["Ethical chamuyo and social influence", "Use charm, warmth, framing, and directness without manipulating or overpromising."],
        ["De-escalating football or politics tension", "Repair group tension while preserving humour, dignity, and relationships."],
        ["Buenos Aires status signals and social codes", "Read cultural capital, neighbourhood references, taste, and conversational positioning."],
        ["A difficult money conversation between friends", "Navigate debt, inflation, resentment, generosity, and saving face."],
        ["Layered irony in dating and attraction", "Handle flirtation, plausible deniability, vulnerability, and backing off gracefully."],
        ["Professional objection handling Argentine style", "Respond to doubts, numbers, trust issues, and vague resistance with local nuance."],
        ["Near-native storytelling with Argentinian rhythm", "Tell a story with digressions, punchlines, self-mockery, and emotional subtext."],
      ],
    },
    "mexican-spanish": {
      B1: [
        ["Ordering tacos at a street stand", "Ask for tacos, salsa, toppings, prices, and to-go options with natural Mexican phrasing."],
        ["Making plans around a tianguis", "Talk about meeting points, shopping, prices, crowds, and what to buy."],
        ["Taking the metro or pesero", "Ask routes, stops, crowds, directions, and arrival updates in simple local Spanish."],
        ["Family comida on Sunday", "Talk about food, compliments, portions, family greetings, and polite refusals."],
        ["Going for pan dulce and coffee", "Order bakery items, compare preferences, and react to recommendations."],
        ["Simple Día de Muertos plans", "Talk about altars, food, flowers, family, and visiting places respectfully."],
        ["Watching a lucha libre show", "Buy tickets, react to the show, invite friends, and describe excitement."],
        ["Asking about spicy salsa", "Ask how spicy something is, request salsa apart, and react to food."],
        ["A quick Oxxo or corner-store errand", "Ask for items, prices, payment, bags, and simple help."],
        ["Meeting friends at a plaza or mall", "Coordinate times, locations, delays, and casual changes of plan."],
      ],
      B2: [
        ["Tianguis bargaining without sounding rude", "Ask prices, compare quality, negotiate softly, and walk away politely."],
        ["Día de Muertos with family context", "Explain traditions, memories, offerings, food, and respectful curiosity."],
        ["Street-food crawl with mixed opinions", "React to tacos, elotes, tortas, spice, hygiene worries, and recommendations."],
        ["Dealing with traffic in CDMX", "Explain delays, routes, frustration, ride-share issues, and backup plans."],
        ["Complaining about a delivery app order", "Handle missing items, late delivery, refunds, and polite but firm complaint language."],
        ["Planning a quinceañera or big family event", "Discuss outfits, money, logistics, family expectations, and social pressure."],
        ["Work lunch with Mexican politeness", "Make small talk, soften disagreement, discuss food, and keep rapport."],
        ["Lucha libre banter and teasing", "React to spectacle, jokes, masks, rivalry, and playful exaggeration."],
        ["Explaining regional Mexican food differences", "Compare northern, central, coastal, and Yucatán food without overgeneralising."],
        ["A beach trip to the coast with friends", "Negotiate costs, timing, transport, food, safety, and group mood."],
      ],
      C1: [
        ["Reading indirectness in Mexican politeness", "Interpret soft refusals, hedging, ahorita, and conflict avoidance."],
        ["Class and formality in Mexican service encounters", "Adjust tone with staff, clients, elders, and friends without sounding cold."],
        ["Family pressure and saving face", "Discuss expectations, guilt, respect, privacy, and boundaries with nuance."],
        ["When teasing becomes carrilla", "Calibrate joking, repair discomfort, and avoid humiliating someone."],
        ["Talking about safety without panic", "Discuss precautions, local advice, trust, and risk realistically."],
        ["Workplace hierarchy and indirect disagreement", "Challenge ideas with tact, softeners, and culturally natural phrasing."],
        ["Regional pride and stereotypes in Mexico", "Talk about norteño, chilango, jarocho, tapatío, and Yucatecan references carefully."],
        ["Money, generosity, and who pays", "Navigate invitations, covering someone, splitting, and embarrassment discreetly."],
        ["Modern dating with Mexican subtext", "Read signals, consent, humour, intensity, and graceful retreat."],
        ["Telling a chaotic Mexican story", "Use connectors, punchlines, exaggeration, and local rhythm naturally."],
      ],
      C2: [
        ["Subtext in Mexican conflict avoidance", "Decode what is not being said, soften directness, and repair tension."],
        ["Ethical persuasion in a Mexican work context", "Build trust, avoid vender humo, address doubts, and close respectfully."],
        ["Social class signals in speech and taste", "Discuss status, education, neighbourhoods, and code-switching with care."],
        ["High-context family disagreement", "Set boundaries while preserving warmth, respect, and face."],
        ["Banter, albur, and double meaning boundaries", "Understand layered humour, sexual double meanings, and when not to participate."],
        ["Handling resentment and ego in friendship", "Address pride, jealousy, indirect digs, and emotional defensiveness."],
        ["Crisis talk after a public-service failure", "Complain, coordinate, blame carefully, and push for a solution."],
        ["Migration, identity, and Spanglish contact", "Discuss belonging, language mixing, family expectations, and cultural identity."],
        ["De-escalating a group conflict at a party", "Untangle blame, gossip, loyalties, and face-saving exits."],
        ["Near-native storytelling with Mexican suspense", "Use pacing, callbacks, irony, and local connectors to tell a vivid story."],
      ],
    },
    "dominican-spanish": {
      B1: [
        ["Buying breakfast at a Dominican colmado", "Ask for food, prices, change, bags, and quick neighbourhood small talk."],
        ["Making beach plans with friends", "Build phrases for time, transport, food, weather, and simple invitations."],
        ["Reacting to merengue or bachata at a party", "Say what music you like, invite someone to dance, and react naturally."],
        ["Simple baseball watch-party plans", "Talk about teams, snacks, arrival times, and cheering with friends."],
        ["Ordering pica pollo or chimi", "Ask for food, sauces, drinks, prices, and to-go options."],
        ["Asking directions in Santo Domingo", "Ask for streets, corners, taxis, traffic, and where to get off."],
        ["Visiting family on Sunday", "Use greetings, food compliments, simple questions, and polite refusals."],
        ["Carnival parade basics", "Talk about masks, music, crowds, meeting points, and photos."],
        ["Quick WhatsApp voice-note updates", "Send simple Dominican-style updates about delays, plans, and location."],
        ["A corner-store errand with neighbours", "Buy basics, ask what's fresh, chat briefly, and say goodbye naturally."],
      ],
      B2: [
        ["Colmado credit, trust, and neighbourhood talk", "Discuss owing, paying later, favours, gossip, and social closeness."],
        ["Baseball rivalry without causing drama", "React to teasing, predictions, losses, and passionate disagreement."],
        ["Bachata lyrics and emotional storytelling", "Talk about love, heartbreak, pride, and jokes around music."],
        ["Planning a resort versus local beach day", "Compare costs, transport, food, expectations, and group preferences."],
        ["Carnival logistics and street safety", "Discuss crowds, routes, costumes, timing, caution, and group coordination."],
        ["Family pressure at a Dominican gathering", "Handle food, questions, teasing, advice, and polite boundaries."],
        ["Moto-concho and traffic conversations", "Talk about routes, prices, risk, speed, and arrival updates."],
        ["Reacting to a neighbourhood rumour", "Ask what happened, show disbelief, avoid taking bait, and de-escalate."],
        ["Money talk around going out", "Split costs, ask favours, mention being short, and avoid embarrassment."],
        ["Explaining Dominican speech to a visitor", "Describe speed, reductions, tone, and informal expressions respectfully."],
      ],
      C1: [
        ["Reading Dominican humour and provocation", "Interpret teasing, cuerda, gufeo, and when someone is actually annoyed."],
        ["Status, respect, and street-smart phrasing", "Discuss confidence, boundaries, reputation, and social risk with nuance."],
        ["Dealing with allante and appearance", "Talk about bluffing, image, exaggeration, and what is really going on."],
        ["Family loyalty versus personal boundaries", "Set limits while preserving warmth, respect, and connection."],
        ["Dominican conflict de-escalation", "Handle quille, boche, pique, mareo, and direct emotional repair."],
        ["Diaspora Dominican identity conversation", "Discuss belonging, accent, Spanish/English mixing, and family expectations."],
        ["Music, class, and social perception", "Talk about dembow, bachata, merengue, taste, status, and judgement carefully."],
        ["When helping becomes being used", "Discuss favours, money, loyalty, and resentment without sounding cold."],
        ["Professional tone with Dominican warmth", "Switch between friendly local tone and clear work boundaries."],
        ["Reading a tense Dominican group chat", "Decode indirect digs, voice notes, silence, reactions, and repair attempts."],
      ],
      C2: [
        ["Layered Dominican emotional confrontation", "Speak frankly while managing quille, pride, accusation, and repair."],
        ["Subtext in Dominican streetwise negotiation", "Read bluff, pressure, favours, loyalty, and practical compromise."],
        ["High-stakes family money conversation", "Discuss obligation, resentment, dignity, and boundaries with cultural tact."],
        ["De-escalating a public embarrassment", "Handle boche, reputation, witnesses, apology, and saving face."],
        ["Dominican humour at the edge of conflict", "Use and interpret gufeo, cuerda, exaggeration, and social limits."],
        ["Diaspora code-switching and identity tension", "Navigate English, Spanish, belonging, authenticity, and judgement."],
        ["Power and trust in neighbourhood networks", "Discuss connections, favours, reputation, and who can resolve what."],
        ["Romantic ambiguity and pride", "Handle attraction, jealousy, indirect signals, and backing off with dignity."],
        ["Professional pushback with Caribbean directness", "Challenge scope, money, deadlines, and vague promises without burning rapport."],
        ["Near-native storytelling with Dominican drama", "Tell a vivid story using suspense, reactions, humour, and emotional precision."],
      ],
    },
    "peruvian-spanish": {
      B1: [
        ["Ordering menú at a Peruvian lunch spot", "Ask for menu options, prices, drinks, and simple food preferences."],
        ["Taking a combi or corredor in Lima", "Ask routes, stops, fares, crowds, and arrival updates."],
        ["Planning ceviche with friends", "Make lunch plans, discuss time, place, freshness, and simple preferences."],
        ["Buying snacks at a bodega", "Ask for basics, prices, bags, change, and quick recommendations."],
        ["A Miraflores meetup by the malecón", "Coordinate meeting points, walking plans, weather, and photos."],
        ["Simple family lunch with ají and cancha", "Talk about food, spice, portions, compliments, and polite refusal."],
        ["Going to a peña criolla", "Say what music you like, invite friends, and react to dancing and songs."],
        ["Asking about Yape payments", "Use simple phrases for digital payment, owing money, and confirming transfers."],
        ["Market fruit and juice stand", "Ask prices, flavours, quantities, and recommendations at a market."],
        ["Weekend trip to the beach south of Lima", "Make simple plans around transport, food, timing, and sunscreen."],
      ],
      B2: [
        ["Splitting a cevichería bill with Yape", "Discuss costs, transfers, being short, fairness, and awkward money moments."],
        ["Lima traffic and late arrivals", "Explain delays, transport choices, missed combis, and realistic arrival times."],
        ["Explaining Peruvian food pride", "Recommend dishes, compare regions, and react to strong opinions about food."],
        ["Planning around Mistura-style food events", "Talk about crowds, stands, prices, favourites, and group decisions."],
        ["Cusco trip logistics with local sensitivity", "Discuss altitude, tickets, tours, prices, and respectful travel."],
        ["Family expectations at a Peruvian gathering", "Handle food pressure, teasing, greetings, and questions politely."],
        ["When a plan gives roche", "Talk about embarrassment, awkwardness, delays, and repairing the situation."],
        ["Football night with friends", "React to the match, teasing, disappointment, and group plans after."],
        ["Shopping at Gamarra or a busy market", "Ask for prices, sizes, quality, discounts, and practical advice."],
        ["Beach house weekend with mixed budgets", "Negotiate money, food, sleeping arrangements, transport, and fairness."],
      ],
      C1: [
        ["Reading roche in Peruvian social situations", "Interpret embarrassment, indirectness, silence, and attempts to save face."],
        ["Professional boundaries with Peruvian softness", "Set limits, discuss scope, and avoid sounding harsh or distant."],
        ["Lima class signals and neighbourhood talk", "Discuss districts, safety, status, and assumptions with care."],
        ["Food as identity and social pride", "Talk about cuisine, regional pride, criticism, and taste without sounding dismissive."],
        ["Indirect disagreement among friends", "Push back with softeners, humour, and local phrasing without creating tension."],
        ["When joking turns into agarrar de punto", "Read teasing, discomfort, group pressure, and repair the mood."],
        ["Discussing informal work and side hustles", "Talk about cachuelos, money pressure, favours, and practical problem-solving."],
        ["Navigating family advice and pressure", "Respond to concern, criticism, expectations, and boundaries respectfully."],
        ["Reading romantic signals at a party", "Interpret sajiro, bola, paltearse, and subtle social openings."],
        ["A delicate conversation about safety in Lima", "Talk about caution, trust, transport, and privilege without exaggerating."],
      ],
      C2: [
        ["Peruvian indirectness under emotional pressure", "Handle disagreement, shame, pride, and face-saving with near-native nuance."],
        ["Negotiating money, role, and scope in Peru", "Set boundaries around tarifa, alcance, compromise, and professional respect."],
        ["Class, district, and social perception in Lima", "Discuss sensitive status signals and assumptions without sounding judgemental."],
        ["Advanced humour that almost crosses the line", "Use chacota, sarcasm, repair, and social calibration at speed."],
        ["Romantic subtext and awkwardness at a party", "Read interest, rejection, space, and social risk with precision."],
        ["Family duty versus personal autonomy", "Discuss obligation, guilt, help, and limits with warmth and firmness."],
        ["Food criticism without offending national pride", "Give nuanced opinions on cuisine, taste, and identity respectfully."],
        ["De-escalating a group roche", "Repair embarrassment, public tension, blame, and awkward silence."],
        ["Professional persuasion without overcommitting", "Handle client pressure, budget limits, scope changes, and final terms."],
        ["Near-native Peruvian storytelling", "Tell stories with understatement, local connectors, awkward humour, and emotional restraint."],
      ],
    },
    "cuban-spanish": {
      B1: [
        ["Ordering cafecito and pastelitos", "Ask for Cuban coffee, snacks, prices, and simple friendly small talk."],
        ["Taking a guagua or almendrón", "Ask routes, fares, stops, crowds, and where to get off."],
        ["Making plans on the Malecón", "Coordinate meeting points, time, weather, walking, and casual invitations."],
        ["Listening to son or salsa with friends", "Say what music you like, invite someone to dance, and react naturally."],
        ["Buying fruit at an agromercado", "Ask prices, quantities, freshness, and recommendations in simple Cuban Spanish."],
        ["A family rice-and-beans lunch", "Talk about food, portions, compliments, and polite refusal."],
        ["Simple baseball conversation", "Talk about teams, watching the game, snacks, and reactions."],
        ["Going to the beach with friends", "Make simple plans around transport, food, timing, and weather."],
        ["Quick neighbourhood greetings", "Build casual greetings, check-ins, goodbyes, and short replies."],
        ["Asking about music and dancing", "Ask what is playing, say you can or cannot dance, and join a plan."],
      ],
      B2: [
        ["Almendrón negotiation and route confusion", "Discuss fares, routes, waiting, wrong turns, and practical transport fixes."],
        ["Cuban coffee as social ritual", "Talk about offering coffee, refusing politely, gossip, and quick visits."],
        ["Baseball rivalry and friendly teasing", "React to teams, losses, jokes, and passionate disagreement without drama."],
        ["Planning around limited supplies", "Discuss what is available, substitutions, favours, and practical problem-solving."],
        ["Music night in Havana", "Talk about live music, dancing, crowds, invitations, and social energy."],
        ["Family abroad and voice-note updates", "Discuss relatives, remittances, calls, time zones, and emotional check-ins."],
        ["Beach day logistics with mixed budgets", "Negotiate transport, food, contributions, timing, and backup plans."],
        ["Neighbourhood favour culture", "Ask favours, repay help, manage expectations, and avoid sounding entitled."],
        ["Street food and paladar recommendations", "Recommend places, discuss prices, quality, service, and local taste."],
        ["Carnival or street celebration plans", "Coordinate crowds, music, safety, meeting points, and changed plans."],
      ],
      C1: [
        ["Cuban humour under scarcity", "Use and interpret jokes, resilience, frustration, and indirect complaint."],
        ["Resolver as a cultural survival skill", "Talk about improvising, finding solutions, favours, and practical intelligence."],
        ["Diaspora calls and emotional distance", "Discuss leaving, staying, helping, guilt, nostalgia, and family pressure."],
        ["Reading Cuban directness versus warmth", "Interpret bluntness, affection, teasing, and social closeness."],
        ["Music, pride, and generational taste", "Discuss son, salsa, timba, reguetón, identity, and respectful disagreement."],
        ["When a favour becomes pressure", "Set limits, talk about obligation, gratitude, and resentment tactfully."],
        ["Neighbourhood reputation and trust", "Discuss who knows whom, gossip, reliability, and social consequences."],
        ["Romantic teasing and boundaries Cuban style", "Read playful interest, pressure, refusal, and graceful backing off."],
        ["Talking about daily obstacles without despair", "Balance humour, complaint, resilience, and practical action."],
        ["Professional tone with Cuban warmth", "Shift between familiar speech, clear boundaries, and respectful negotiation."],
      ],
      C2: [
        ["Subtext in Cuban complaint and humour", "Decode irony, frustration, resilience, and what is safer left unsaid."],
        ["High-stakes family diaspora negotiation", "Discuss money, help, guilt, autonomy, and love without collapsing the relationship."],
        ["Resolver without overpromising", "Persuade, improvise, and set realistic limits in uncertain conditions."],
        ["Cuban social status and reputation", "Read confidence, connections, image, trust, and who can get things done."],
        ["Political sensitivity in everyday conversation", "Navigate caution, ambiguity, indirectness, and topic-shifting safely."],
        ["Emotional honesty across distance", "Talk about missing someone, resentment, loyalty, and fatigue with precision."],
        ["Music as identity and argument", "Debate taste, authenticity, generational change, and cultural pride with tact."],
        ["De-escalating a heated neighbourhood conflict", "Handle witnesses, pride, accusations, humour, and repair."],
        ["Advanced romantic subtext and dignity", "Handle flirtation, desire, reputation, refusal, and consent-aware pacing."],
        ["Near-native Cuban storytelling", "Tell vivid stories with speed, humour, callbacks, tension, and emotional shifts."],
      ],
    },
    "andalusian-spanish": {
      B1: [
        ["Ordering tapas in Seville", "Ask for tapas, drinks, prices, recommendations, and simple bar phrases."],
        ["Making plans for feria", "Talk about meeting points, clothes, music, food, and simple invitations."],
        ["Semana Santa street basics", "Ask about processions, routes, crowds, timing, and respectful behaviour."],
        ["Beach day on the Costa del Sol", "Make simple plans around transport, sun, food, and timing."],
        ["Buying churros and coffee", "Order breakfast, ask prices, choose portions, and react politely."],
        ["Asking directions in a white village", "Ask for streets, hills, landmarks, and walking directions."],
        ["Simple flamenco night plans", "Invite friends, ask about music, react to singing, and talk about feelings."],
        ["Market shopping for olives and fruit", "Ask prices, quantities, freshness, and recommendations."],
        ["Meeting friends in a plaza", "Coordinate time, place, greetings, delays, and casual changes."],
        ["Talking about heat and summer plans", "Explain heat, tiredness, shade, drinks, and slower plans."],
      ],
      B2: [
        ["Tapas bar hopping with friends", "Discuss recommendations, sharing plates, prices, crowded bars, and changing plans."],
        ["Feria logistics and social codes", "Talk about casetas, invitations, outfits, dancing, timing, and group expectations."],
        ["Semana Santa crowds and respect", "Discuss routes, waiting, silence, emotion, and how to behave respectfully."],
        ["Explaining Andalusian accent to a visitor", "Describe reductions, seseo/ceceo, ustedes, and comprehension strategies."],
        ["Heatwave complaints and daily rhythm", "Talk about heat, errands, work timing, rest, and practical adjustments."],
        ["Coastal tourism versus local life", "Compare beaches, crowds, prices, work, and local frustration politely."],
        ["Flamenco emotions without clichés", "React to performance, duende, emotion, technique, and atmosphere naturally."],
        ["Family lunch with pescaíto or gazpacho", "Handle food pressure, compliments, portions, and local food pride."],
        ["Village gossip and social closeness", "React to rumours, neighbours, reputations, and avoiding trouble."],
        ["A train or bus delay across Andalusia", "Explain delays, connections, station confusion, and backup plans."],
      ],
      C1: [
        ["Accent prejudice and Andalusian pride", "Discuss accent, class, stereotypes, media, and identity with nuance."],
        ["Reading humour in Andalusian understatement", "Interpret irony, exaggeration, affection, and when jokes hide criticism."],
        ["Feria invitations and social access", "Navigate insider/outsider dynamics, invitations, refusals, and awkwardness."],
        ["Semana Santa emotion and secular discomfort", "Talk respectfully about devotion, tradition, scepticism, and public emotion."],
        ["Tourism pressure in Málaga or Seville", "Discuss housing, prices, jobs, locals, and visitors without sounding simplistic."],
        ["Andalusian professional warmth", "Balance friendliness, clarity, boundaries, and seriousness in work contexts."],
        ["When no pasa nada actually matters", "Read relaxed phrasing, hidden irritation, and conflict avoidance."],
        ["Food pride and regional rivalry", "Discuss tapas, olive oil, seafood, gazpacho, and rival claims playfully."],
        ["Rural versus city Andalusian identities", "Talk about village closeness, urban anonymity, accent, and pace of life."],
        ["Repairing a joke about accent", "Apologise, reframe, and avoid turning dialect into a caricature."],
      ],
      C2: [
        ["Advanced Andalusian register switching", "Move between local warmth, professional clarity, and standard Spanish without erasing identity."],
        ["Talking about accent discrimination", "Discuss prejudice, pride, humour, class, and linguistic legitimacy with precision."],
        ["Subtext in feria social hierarchy", "Read invitations, access, status, exclusion, obligation, and face-saving."],
        ["Holy Week tension and public emotion", "Navigate devotion, scepticism, family tradition, and respect under disagreement."],
        ["Tourism, housing, and local resentment", "Discuss complex social effects without blaming simplistically or sounding preachy."],
        ["Andalusian humour near the line", "Use irony, affection, exaggeration, and repair when a joke lands badly."],
        ["Negotiating boundaries with warmth", "Set limits while preserving an Andalusian-friendly tone and social ease."],
        ["Regional rivalry with elegance", "Debate Seville, Málaga, Cádiz, Granada, Córdoba, and identity without cheap stereotypes."],
        ["Near-native storytelling in Andalusian rhythm", "Tell a story with local pacing, humour, reductions awareness, and emotional colour."],
        ["Conflict repair after public embarrassment", "Handle pride, witnesses, apology, softening, and returning to normality."],
      ],
    },
    "puerto-rican-spanish": {
      B1: [
        ["Ordering mofongo or alcapurrias", "Ask for Puerto Rican food, prices, recommendations, and simple preferences."],
        ["Beach day at Luquillo or Isla Verde", "Make simple plans around transport, food, weather, and meeting points."],
        ["Chinchorreo basics with friends", "Talk about stops, snacks, drinks, music, and simple invitations."],
        ["Taking a público or ride-share", "Ask pickup points, fares, routes, traffic, and arrival updates."],
        ["Family Christmas parranda basics", "Talk about music, visits, food, greetings, and late-night plans."],
        ["Shopping at a panadería", "Order coffee, sandwiches, pastries, prices, and to-go items."],
        ["Simple salsa or reggaetón conversation", "Say what music you like, invite friends, and react naturally."],
        ["Fiestas patronales meetup", "Coordinate rides, crowds, food, music, and meeting places."],
        ["A quick colmado errand", "Ask for snacks, drinks, prices, and simple neighbourhood chat."],
        ["Rainy tropical afternoon plans", "Explain rain, traffic, changes, delays, and indoor backup plans."],
      ],
      B2: [
        ["Chinchorreo logistics and group money", "Discuss stops, drivers, splitting costs, food, music, and changing plans."],
        ["Puerto Rican Christmas season plans", "Talk about parrandas, family visits, food, exhaustion, and social pressure."],
        ["Reggaetón versus salsa taste debate", "Express opinions, tease lightly, compare generations, and avoid judging."],
        ["Hurricane-season preparation chat", "Discuss supplies, family check-ins, stress, power outages, and neighbour help."],
        ["Festival food and crowd navigation", "Handle kiosks, lines, prices, meeting points, and group decisions."],
        ["Diaspora family visit to the island", "Discuss belonging, accent, family expectations, and travel plans."],
        ["Beach etiquette and tourist crowds", "Talk about parking, noise, trash, respect, and local frustration."],
        ["Complaining about electricity or service", "Explain outages, delays, bills, calls, and practical next steps."],
        ["Baseball or basketball night with friends", "React to plays, teasing, rivalry, food, and celebration."],
        ["Spanglish in everyday plans", "Use natural code-switching awareness without forcing it into every sentence."],
      ],
      C1: [
        ["Puerto Rican identity and diaspora belonging", "Discuss island/mainland identity, language, accent, family, and authenticity."],
        ["Reading warmth and intensity in Puerto Rican speech", "Interpret affection, directness, teasing, volume, and urgency."],
        ["Talking about outages and resilience", "Balance complaint, humour, fatigue, neighbour support, and practical planning."],
        ["Music, status, and generational taste", "Discuss reggaetón, salsa, plena, bomba, pride, and judgement carefully."],
        ["Family pressure during long holidays", "Handle visits, expectations, food, money, privacy, and boundaries."],
        ["Tourism, beaches, and local frustration", "Discuss respect, economy, housing, crowds, and cultural sensitivity."],
        ["Romantic signals at a party or chinchorreo", "Read interest, teasing, consent, backing off, and group dynamics."],
        ["Professional Puerto Rican warmth and clarity", "Switch between friendly local tone, clear asks, and work boundaries."],
        ["Code-switching without losing register control", "Use and discuss Spanglish, English terms, and Spanish register with nuance."],
        ["Group chat drama after a night out", "Decode reactions, indirect digs, voice notes, and repair attempts."],
      ],
      C2: [
        ["Puerto Rican identity under political subtext", "Discuss status, belonging, diaspora, pride, and disagreement with nuance."],
        ["High-stakes family diaspora conversation", "Talk about distance, money, care, language, guilt, and loyalty precisely."],
        ["De-escalating conflict during a holiday gathering", "Manage pride, witnesses, teasing, apology, and returning to warmth."],
        ["Music as cultural argument", "Debate authenticity, commercialisation, class, race, and generation without flattening."],
        ["Tourism, gentrification, and beach access", "Discuss complex local concerns with tact, evidence, and emotional intelligence."],
        ["Advanced Spanglish and register control", "Switch naturally while explaining when code-switching sounds intimate, casual, or inappropriate."],
        ["Hurricane memory and emotional resilience", "Discuss trauma, humour, preparation, frustration, and solidarity with care."],
        ["Romantic subtext in a high-energy social scene", "Handle desire, ambiguity, consent, friends watching, and graceful retreat."],
        ["Professional persuasion with Puerto Rican warmth", "Build trust, respond to pushback, and close without sounding cold or pushy."],
        ["Near-native Puerto Rican storytelling", "Tell a vivid story with rhythm, callbacks, reactions, humour, and emotional texture."],
      ],
    },
  };
  ...
  return getSpecialCourses().flatMap((course) => {
    ...
    const gen3TopicsByLevel = gen3ByCourse[course.id];
    const cultureTopics = gen3TopicsByLevel
        ...
        <div class="selector-grid">
          ...
          <section id="specialSelectorControls" class="selector-controls hidden">
            ...
            <div class="topic-generation-tabs" role="tablist" aria-label="Special topic generation">
              ...
              <button id="specialGen3Tab" class="topic-generation-tab" type="button" data-special-generation="gen3">Gen 3 - culture</button>
            </div>
            <div class="selector-field">
    ...
    <script>
      ...
      function getSpecialCoursePromptAppendix(course, topic) {
        ...
        return [
          ...
          topic.generation === "gen3"
            ? "Generation 3 culture-specific topic: make the lesson culturally anchored in the selected country/region, but still language-first. Teach phrases the learner can say in real situations linked to this cultural context. Do not turn it into a tourism facts lecture."
            : "",
