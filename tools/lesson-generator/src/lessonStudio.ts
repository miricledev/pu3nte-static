...
Timing rules:
- Prompt and repeat segments should usually have showTimer: true and responsePauseMs between 3000 and 7000.
- For short beginner prompts, use responsePauseMs around 3000-4500. Use 6000-7000 only for longer final challenges.
...
- Short prompts: "responsePauseMs": 3000-4500.
- Medium prompts: "responsePauseMs": 4500-6000.
- Final challenge: "responsePauseMs": 6000-7000.
    ...
    <script>
      ...
      function getSpecialCoursePromptAppendix(course, topic) {
        ...
        return [
          ...
          "Build an internal phrase bank of at least 25 useful " + course.variety + " local expressions before writing the lesson. Use at least 15-20 of them naturally across prompts, answers, repeats, mini-dialogues, reviews, and the final challenge. Do not output the phrase bank separately; weave it into the JSON lesson.",
          "Reference example only, not a mandatory phrase list: in Colombian Spanish, the kind of everyday local material to research might include greetings like qué más / quiubo, reactions like uy / de una / listo, softeners like qué pena, local words like parce/parcero/tinto, and situational sayings like se está cayendo un aguacero for heavy rain. Do not force these exact examples unless they fit the selected lesson. For every selected country/accent, research equivalent local expressions across many situations: weather, plans, food, transport, money, time, being late, being tired, being annoyed, flirting/banter, work, texting, reacting to stories, and casual problem-solving.",
