...
export const dominicanSpanishC2EmotionalConversationsReading: ReadingComprehension = {
  ...
  data: {
    ...
    paragraphs: [
      { id: "p1", text: "En una conversación dominicana seria, “Yo te voy a hablar claro” anuncia que viene una verdad directa. No es solo vocabulario; es un movimiento social. Cuando alguien añade “sin allante ni mareo”, está pidiendo honestidad, sin actuación y sin dar vueltas.", highlights: highlights(["hablar claro / Yo te voy a hablar claro", "sin allante ni mareo", "allante", "mareo"]), shadowLine: "Yo te voy a hablar claro: sin allante ni mareo." },
      { id: "p2", text: "La rabia tiene capas. “Quille” y “pique” pueden hablar de enojo o irritación, pero “un pique del diablo” es mucho más fuerte. “Estar quillao” o “estar quillá” nombra el estado, mientras “coger un quille” nombra el momento en que empieza la rabia.", highlights: highlights(["quille", "pique", "un pique del diablo", "estar quillao / quillá", "coger un quille"]), shadowLine: "Cogí un quille y todavía estoy quillao." },
      { id: "p3", text: "Bajar la tensión importa tanto como confrontar. “No te pongas guapo” significa que no empieces agresivo. “No te enfogones” pide que no te calientes. “Bajarle el quille a alguien” es calmar la rabia antes de que la conversación se ponga peor.", highlights: highlights(["No te pongas guapo", "ponerse guapo", "No te enfogones", "enfogonarse", "bajarle el quille a alguien"]), shadowLine: "No te enfogones; déjame bajarte el quille." },
      { id: "p4", text: "La evasiva crea sospecha. “No quiero mareo” rechaza explicaciones circulares. “Meter un bobo” es darle a alguien una excusa bien armada para tapar lo que pasó. Si esa excusa se siente rara, “hay un maco ahí” significa que hay un problema escondido.", highlights: highlights(["No quiero mareo", "meter un bobo", "un bobo", "hay un maco ahí", "maco"]), shadowLine: "No quiero mareo; eso me suena a un bobo." },
      { id: "p5", text: "Algunas frases sirven para no entrar en conflicto. “Caer en gancho” es caer en una trampa o provocación, y “comprar un pleito” es meterte en una pelea innecesaria. “No voy a caer en gancho” y “No voy a comprar ese pleito” protegen tu control emocional.", highlights: highlights(["caer en gancho", "gancho", "comprar un pleito", "No voy a caer en gancho", "No voy a comprar ese pleito"]), shadowLine: "No voy a caer en gancho ni a comprar ese pleito." },
      { id: "p6", text: "Reparar exige responsabilidad. “Yo metí la pata” admite que fallaste. “Yo no te tengo dema” dice que no hay mala sangre, aunque haya dolor. “He pasado la de Caín” y “Estoy decricajao” explican cansancio emocional sin fingir que todo está bien.", highlights: highlights(["Yo metí la pata", "meter la pata", "Yo no te tengo dema", "dema", "He pasado la de Caín", "Estoy decricajao"]), shadowLine: "Yo metí la pata, pero no te tengo dema." },
      { id: "p7", text: "En C2, una de las partes más difíciles es detectar la máscara emocional. “Hacer aguaje como que no me importa” significa actuar como si algo no te doliera cuando sí te importa. Si todo el mundo sigue actuando, “se pone feo” y “el maco se pone más feo”. A veces, hablar claro es la opción más cuidadosa.", highlights: highlights(["hacer aguaje", "hacer aguaje como que no me importa", "se pone feo", "el maco se pone más feo"]), shadowLine: "Deja el aguaje, porque si no, se pone feo." },
    ],
