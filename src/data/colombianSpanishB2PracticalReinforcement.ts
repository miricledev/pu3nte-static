...
export const colombianSpanishB2PracticalWhatsAppStory: WhatsAppStory = {
  ...
  data: {
    ...
    messages: [
      ...
      message("m32", "camila", "Total. Si algo no cuadra, buscamos otra solución.", "Totally. If something doesn't work, we'll find another solution.", ["Buscamos otra solución"]),
    ...
    comprehensionChecks: [
      ...
      { id: "practical-check-2", afterMessageId: "m14", question: storyQuestions[1] },
      { id: "practical-check-3", afterMessageId: "m22", question: storyQuestions[2] },
