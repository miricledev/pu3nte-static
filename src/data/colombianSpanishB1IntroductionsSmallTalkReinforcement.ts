...
const storyQuestions: CheckpointQuestion[] = [
  {
    ...
    options: ["Me cogió la tarde por el tráfico", "He forgot the name", "He had no money", "He was buying shoes"],
...
const readingQuestions: CheckpointQuestion[] = [
  ...
  },
  {
    ...
    options: ["hacer una vuelta", "repeat his name", "buy a plane ticket", "call his boss"],
    correctAnswer: "hacer una vuelta",
