...
const storyQuestions: CheckpointQuestion[] = [
  {
    ...
    prompt: "Why is Nico late?",
    options: ["Traffic is bad and transport is packed", "He forgot the restaurant", "He is at home asleep", "He lost his phone"],
    correctAnswer: "Traffic is bad and transport is packed",
    explanation: "Nico mentions traffic, the Metropolitano, the combi, and the micro.",
    points: 1,
    skillTag: "gist",
  },
  {
...
export const peruvianSpanishB1TransportBeingLateWhatsAppStory: WhatsAppStory = {
  ...
  data: {
    ...
    comprehensionChecks: [
      ...
      { id: "peruvian-b1-transport-check-2", afterMessageId: "m10", question: storyQuestions[1] },
      { id: "peruvian-b1-transport-check-3", afterMessageId: "m15", question: storyQuestions[4] },
      { id: "peruvian-b1-transport-check-4", afterMessageId: "m23", question: storyQuestions[3] },
      { id: "peruvian-b1-transport-check-5", afterMessageId: "m30", question: storyQuestions[2] },
    ],
