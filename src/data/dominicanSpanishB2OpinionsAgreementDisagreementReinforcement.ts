...
export const dominicanSpanishB2OpinionsAgreementDisagreementReading: ReadingComprehension = {
  ...
  data: {
    ...
    paragraphs: [
      {
        id: "p1",
        text: "En el español dominicano casual, un desacuerdo muchas veces empieza con cercanía. Un amigo puede abrir con “¿Qué lo qué?” o “Dímelo” antes de preguntar qué tú piensas. Esas frases bajan la tensión antes de soltar la opinión real. Si el tema es un plan social, “esa vaina” o “esa vuelta” puede referirse a toda la situación, no solo a una cosa.",
        highlights: highlights(["¿Qué lo qué?", "Dímelo", "esa vaina", "esa vuelta"]),
        shadowLine: "¿Qué lo qué? Dímelo, ¿qué tú piensas de esa vaina?",
      },
      {
        id: "p2",
        text: "Para dar una opinión sin sonar agresivo, puedes usar “pa’ mí” o “en verdad”. Por ejemplo: “Pa’ mí, esa vuelta está medio rara.” La frase “medio raro” ayuda porque suena más suave que decir que algo está totalmente mal. Así dejas espacio para que la otra persona explique.",
        highlights: highlights(["pa’ mí", "en verdad", "esa vuelta", "medio raro"]),
        shadowLine: "Pa’ mí, esa vuelta está medio rara.",
      },
      {
        id: "p3",
        text: "Cuando los dos lados tienen algo de razón, en dominicano puedes balancear con “por un lao” y “por otro lao”. Puedes decir: “Por un lao, el coro está jevi; por otro lao, ando en olla.” Eso significa que el plan suena bien, pero la situación del dinero también pesa. “Los cuartos” o “lo’ cuarto” significa dinero o efectivo.",
      ...
      {
        id: "p4",
        text: "Un desacuerdo directo todavía puede sonar respetuoso si lo suavizas primero. “No e’ por llevarte la contraria” dice que no estás contradiciendo solo por pelear. Después puedes añadir “yo la veo distinto” o “yo no lo veo así”. Esas frases te ayudan a discrepar sin romper la relación.",
      ...
      {
        id: "p5",
        text: "Un buen desacuerdo también incluye acuerdo. “No te voy a negar...” te permite reconocer una parte del punto de la otra persona, y “claro que sí” marca acuerdo claro. Si la conversación empieza a dar vueltas, “vamo’ a dejarlo ahí” puede cerrar la tensión sin sonar frío.",
      ...
      {
        id: "p6",
        text: "Las frases dominicanas de reparación ayudan a mantener el ambiente bien. “No coja lucha” le dice a alguien que no se estrese. “Bregar con algo” significa resolver o manejar una situación. Si alguien dice “ahorita”, escucha el contexto: puede ser pronto, en un rato o ahora. Si dice “ahora mismo”, el tiempo queda más claro.",
      ...
      {
        id: "p7",
        text: "En un chat real puedes oír “dique” cuando alguien cuenta algo con duda: “Dique era barato.” También puedes oír “pero ven acá...” antes de cuestionar algo, como: “Pero ven acá, ¿por qué avisar ahora?” Esas frases pequeñas hacen que la conversación suene local, viva y socialmente cuidadosa.",
