...
export const dominicanSpanishB1FoodShopsPricesReading: ReadingComprehension = {
  ...
  data: {
    ...
    paragraphs: [
      { id: "p1", text: "Cuando entras a un “colmado” dominicano, un simple “Buenas” suena natural. Después puedes preguntar “¿Qué tú tienes fresco?” si quieres fruta o algo del día. El “colmado” no es solo una tiendita; muchas veces también es un punto del barrio donde la gente saluda, pregunta precios y resuelve rápido.", highlights: highlights(["Buenas", "¿Qué tú tienes fresco?", "colmado"]), shadowLine: "Buenas, ¿qué tú tienes fresco?" },
      { id: "p2", text: "Para preguntar el precio, di “¿A cómo está?” o “¿A cómo está eso?” Son frases directas y normales en una compra. Si el precio te parece alto, puedes decir “Está un poco caro” y negociar suave, sin sonar agresivo.", highlights: highlights(["¿A cómo está?", "¿A cómo está eso?", "Está un poco caro"]), shadowLine: "¿A cómo está eso? Está un poco caro." },
      { id: "p3", text: "En República Dominicana, los nombres de las frutas importan. “Chinola” es la fruta de la pasión, “lechosa” es papaya y “guineo” es banana. Si quieres poca cantidad, puedes decir “Dame un chin de...” porque “un chin” significa un poquito.", highlights: highlights(["chinola", "lechosa", "guineo", "Dame un chin de…", "un chin"]), shadowLine: "Dame un chin de chinola y guineo." },
      { id: "p4", text: "Para comida de base, vas a oír “víveres”. Ahí entran cosas como yuca, plátano, yautía y otros alimentos que llenan. Si quieres comprar para la casa, puedes decir “Échame una funda de víveres”. La palabra “funda” es la bolsa.", highlights: highlights(["víveres", "Échame una funda de…", "funda"]), shadowLine: "Échame una funda de víveres." },
      { id: "p5", text: "La comida de calle tiene su propio ritmo. “Dame un pica pollo” sirve para pedir pollo frito dominicano. “Échame un chimi con to’” pide un chimi con todos los ingredientes. Si no quieres tanto aderezo, añade “sin mucha salsa”.", highlights: highlights(["Dame un pica pollo", "pica pollo", "Échame un chimi con to’", "un chimi", "con to’", "sin mucha salsa"]), shadowLine: "Échame un chimi con to’, sin mucha salsa." },
      { id: "p6", text: "El dinero también suena local. “Cuarto” significa dinero o efectivo, y “no ando con mucho cuarto” quiere decir que no llevas mucho dinero encima. Para negociar, puedes decir “¿No me lo deja en...?” o “Déjamelo en quinientos”.", highlights: highlights(["cuarto", "no ando con mucho cuarto", "¿No me lo deja en…?", "Déjamelo en quinientos"]), shadowLine: "No ando con mucho cuarto. ¿No me lo deja en quinientos?" },
      { id: "p7", text: "Para cerrar la compra, “Me lo llevo” funciona con una cosa y “Me los llevo” con varias. “Dale” confirma el trato. Después puedes pedir “Échamelo en una funda” para que te lo pongan en una bolsa.", highlights: highlights(["Me lo llevo", "Me los llevo", "Dale", "Échamelo en una funda"]), shadowLine: "Dale, me lo llevo. Échamelo en una funda." },
    ],
