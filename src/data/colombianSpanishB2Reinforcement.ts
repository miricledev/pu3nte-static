...
export const colombianSpanishB2WhatsAppStory: WhatsAppStory = {
  ...
  data: {
    ...
    messages: [
      message("n1", "narrator", "Scene 1: Nico is supposed to arrive at the office early, but a tiny coffee plan turns into a very Colombian chain reaction.", "Scene 1: Nico is supposed to arrive at the office early, but a tiny coffee plan turns into a very Colombian chain reaction.", ["oficina", "tinto"], "narrator"),
      message("m1", "nico", "¿Qué más, Vale? Parce, te cuento una vuelta rapidito antes de entrar a la oficina.", "What's up, Vale? Mate, let me tell you something real quick before going into the office.", ["¿Qué más?", "parce", "te cuento una vuelta", "una vuelta", "rapidito", "oficina"]),
      message("m2", "vale", "Dale, parcero. Pero tranqui y sin afán, que yo apenas voy por mi primer tinto.", "Go on, buddy. But chill and no rush, I'm only on my first coffee.", ["parcero", "tranqui", "sin afán", "tinto"]),
      message("m3", "nico", "Bueno, resulta que… salí por un tintico de cinco minutos y terminé viviendo una mini novela.", "Well, it turns out that... I went out for a five-minute little coffee and ended up living a mini soap opera.", ["resulta que…", "tintico", "parece una novela"]),
      message("m4", "nico", "Uy, se vino un aguacero berraco, de esos que vuelven todo horrible en dos segundos. Yo quedé empapado antes de cruzar la calle.", "Oof, a brutal downpour started, the kind that makes everything awful in two seconds. I got soaked before crossing the street.", ["uy", "aguacero berraco", "aguacero", "horrible", "empapado"], "voice-note", "/audio/stories/colombian-spanish-b2-aguacero-adventure/m4.mp3"),
      message("m5", "vale", "¿Aguacero berraco? Ya te veo corriendo con cara de ese man sí la pasó mal.", "A brutal downpour? I can already picture you running with that 'that guy really had a rough time' face.", ["aguacero berraco", "ese man", "sí la pasó mal"]),
      message("m6", "nico", "Total. Me metí en una tiendita mientras escampa, todo estresado, mirando el celular como perdido.", "Totally. I went into a little shop while the rain stopped, really stressed, looking at my phone like I was lost.", ["tiendita", "mientras escampa", "todo estresado", "celular"]),
      message("m7", "dona-marta", "Bien pueda, mijo. A la orden. Entre sin pena, que afuera se está cayendo un aguacero de verdad.", "Come in, dear. At your service. Come in, don't be embarrassed, because a real downpour is coming down outside.", ["bien pueda", "mijo / mija", "a la orden", "aguacero"]),
      message("n2", "narrator", "Checkpoint: the shop language is soft and warm. Colombian service Spanish often sounds indirect and affectionate: bien pueda, a la orden, mijo, ¿me regala...?", "Checkpoint: the shop language is soft and warm. Colombian service Spanish often sounds indirect and affectionate: bien pueda, a la orden, mijo, ¿me regala...?", ["bien pueda", "a la orden", "mijo / mija", "¿me regala…?"], "narrator"),
      message("m8", "nico", "Qué pena, señora, ¿me regala un tinto o un tintico mientras escampa? Le pago en efectivo.", "Excuse me, ma'am, could I have a coffee or a little coffee while the rain stops? I'll pay in cash.", ["qué pena", "¿me regala…?", "tinto", "tintico", "mientras escampa", "en efectivo"]),
      message("m9", "dona-marta", "Con mucho gusto, querido. El tintico son dos lucas, pero si está empapado, primero respire.", "With pleasure, dear. The little coffee is two thousand pesos, but if you're soaked, breathe first.", ["con mucho gusto", "querida / querido", "tintico", "dos lucas", "empapado"]),
      message("m10", "dona-marta", "Fresco, mijo, no se preocupe. Se toma el tinto sin afán y cuando escampe miramos cómo sale.", "Don't worry, dear, it's fine. Drink the coffee with no rush and when the rain stops we'll see how you get out.", ["fresco / fresca", "mijo / mija", "no se preocupe", "tinto", "sin afán"], "voice-note", "/audio/stories/colombian-spanish-b2-aguacero-adventure/m10.mp3"),
      message("m11", "nico", "Ahí fue cuando me dio pena, porque saqué la billetera y me di cuenta de que no tenía ni una luca.", "That was when I felt embarrassed, because I took out my wallet and realized I didn't have even one thousand pesos.", ["ahí fue cuando…", "me dio pena", "me di cuenta de que…", "lucas"]),
      message("m12", "vale", "Nooo, parce. La vuelta es que ibas por café y terminaste fiado en una tiendita.", "Nooo, mate. The thing is you went out for coffee and ended up buying on credit in a little shop.", ["parce", "la vuelta es que…", "tiendita"]),
      message("m13", "nico", "Exacto. Y la señora, toda querida, me dijo que tranquilo, que después le llevaba las lucas.", "Exactly. And the lady, really kind, told me not to worry, that I could bring her the money later.", ["querida / querido", "tranquilos", "lucas"]),
      message("m14", "vale", "Qué nota esa señora. Una arepita y un tinto de ahí deben saber a salvación.", "That lady is so cool. A little arepa and a coffee from there must taste like salvation.", ["qué nota", "arepita", "tinto"]),
      message("n3", "narrator", "Scene 2: the weather problem becomes a WhatsApp logistics problem. Listen for location, voice notes, warnings, and traffic.", "Scene 2: the weather problem becomes a WhatsApp logistics problem. Listen for location, voice notes, warnings, and traffic.", ["ubicación", "nota de voz", "trancón"], "narrator"),
      message("m15", "laura", "Oye, qué pena molestarte. ¿Nos mandas la ubicación rapidito? La pelada nueva y yo estamos dando vueltas.", "Hey, sorry to bother you. Can you send us the location real quick? The new girl and I are going around in circles.", ["oye", "qué pena molestarte", "¿nos mandas…?", "ubicación", "rapidito", "pelada"]),
      message("m16", "nico", "Listo, se la mando ya. Pero ojo, pilas con el celular por esa esquina; por acá toca no dar papaya.", "Okay, I'll send it now. But watch out, be careful with your phone on that corner; around here you can't make yourself an easy target.", ["listo", "se la mando ya", "ojo", "pilas", "celular", "no dar papaya"], "voice-note", "/audio/stories/colombian-spanish-b2-aguacero-adventure/m16.mp3"),
      message("m17", "laura", "De una. Guardo el celular y miro la ubicación adentro. No quiero dar papaya por andar distraída.", "Absolutely. I'll put away my phone and check the location inside. I don't want to make myself an easy target by being distracted.", ["de una", "celular", "ubicación", "no dar papaya"]),
      message("m18", "andres", "Parce, yo voy tarde también. Estoy atrapado en el trancón y la buseta viene llenísima.", "Mate, I'm late too. I'm stuck in traffic and the small bus is completely full.", ["parce", "atrapado en el trancón", "trancón", "buseta", "llenísima"]),
      message("m19", "vale", "¿Trancón horrible por el aguacero?", "Awful traffic jam because of the downpour?", ["trancón", "horrible", "aguacero"]),
      message("m20", "andres", "Horrible. Nos tocó esperar como veinte minutos bajo techo, ni modo.", "Awful. We had to wait under a roof for about twenty minutes, oh well.", ["horrible", "nos tocó esperar", "ni modo"]),
      message("m21", "nico", "Mientras tanto, Doña Marta me dio una arepita caliente y eso nos subió el ánimo de una.", "Meanwhile, Doña Marta gave me a hot little arepa and that lifted our mood immediately.", ["mientras tanto", "arepita", "nos subió el ánimo", "de una"]),
      message("m22", "laura", "Qué nota. Más bien quédense en la tiendita; por lo menos están secos, con tinto y sin tanto estrés.", "That's cool. Actually, stay in the little shop; at least you're dry, with coffee, and without so much stress.", ["qué nota", "más bien", "tiendita", "por lo menos", "tinto"], "voice-note", "/audio/stories/colombian-spanish-b2-aguacero-adventure/m22.mp3"),
      message("m23", "dona-marta", "Tranquilos, mijos. Aquí caben todos. Si llega medio mundo, pues medio mundo toma tintico.", "Relax, dears. Everyone fits here. If everyone arrives, then everyone gets a little coffee.", ["tranquilos", "mijo / mija", "medio mundo", "tintico"]),
      message("m24", "nico", "Imagínate que al final llegó Laura con la pelada nueva, y Andrés mandando nota de voz desde la buseta.", "Imagine this: in the end Laura arrived with the new girl, and Andrés was sending voice notes from the bus.", ["imagínate que…", "al final", "pelada", "nota de voz", "buseta"]),
      message("m25", "andres", "Ese man del conductor cerró la puerta y yo quedé muerto de la risa, pero todo estresado.", "That driver guy closed the door and I ended up cracking up, but really stressed.", ["ese man", "muerto de la risa", "todo estresado"]),
      message("m26", "vale", "Esto parece una novela: aguacero, trancón, tintico, ubicación, celular y todo el mundo perdido.", "This is like a soap opera: downpour, traffic jam, little coffee, location, phone, and everyone lost.", ["parece una novela", "aguacero", "trancón", "tintico", "ubicación", "celular"]),
      message("n4", "narrator", "Scene 3: now the comedy repeats the same useful chunks. The goal is not just understanding once; it is hearing the phrases until they feel natural.", "Scene 3: now the comedy repeats the same useful chunks. The goal is not just understanding once; it is hearing the phrases until they feel natural.", [], "narrator"),
      message("m27", "nico", "La vuelta es que me cogió la tarde, sí, pero la tiendita me hizo el día.", "The thing is I ended up running late, yes, but the little shop made my day.", ["la vuelta es que…", "me cogió la tarde", "tiendita", "me hizo el día"]),
      message("m28", "andres", "A mí también me cogió la tarde. Pero esa arepita de Doña Marta nos subió el ánimo; no todo fue cansón.", "I ended up running late too. But that little arepa from Doña Marta lifted our mood; not everything was annoying.", ["me cogió la tarde", "arepita", "nos subió el ánimo", "cansón"], "voice-note", "/audio/stories/colombian-spanish-b2-aguacero-adventure/m28.mp3"),
      message("m29", "laura", "Yo llegué empapada y me dio pena, pero Doña Marta dijo: fresco, mija, bien pueda.", "I arrived soaked and felt embarrassed, but Doña Marta said: don't worry, dear, come in.", ["empapado", "me dio pena", "fresco / fresca", "mijo / mija", "bien pueda"]),
      message("m30", "dona-marta", "Claro, querida. A la orden. ¿Me regala un momentico y le caliento otra arepita?", "Of course, dear. At your service. Give me a little moment and I'll heat another little arepa for you?", ["querida / querido", "a la orden", "¿me regala…?", "arepita"]),
      message("m31", "vale", "Jajaja, medio mundo muerto de la risa y todos hablando como si fueran clientes de toda la vida.", "Haha, everyone cracking up and everyone talking like lifelong customers.", ["medio mundo", "muerto de la risa"]),
      message("m32", "nico", "Ahí fue cuando rematé diciendo: uno sale por un tinto y termina con una aventura.", "That was when I wrapped up by saying: you go out for a coffee and end up with an adventure.", ["ahí fue cuando…", "rematé diciendo", "uno sale por…", "tinto", "termina con una aventura"]),
      message("m33", "andres", "Bacano. Pero pilas, que si uno sale por un tinto sin mirar el clima, le cae otro aguacero berraco.", "Cool. But be careful, because if you go out for a coffee without checking the weather, another brutal downpour gets you.", ["bacano / bacana", "pilas", "uno sale por…", "tinto", "aguacero berraco"]),
      message("m34", "dona-marta", "Ni modo, mijos. En Bogotá uno aprende: si llueve, se espera; si hay trancón, se toma tintico.", "Oh well, dears. In Bogotá you learn: if it rains, you wait; if there's traffic, you drink a little coffee.", ["ni modo", "mijo / mija", "trancón", "tintico"], "voice-note", "/audio/stories/colombian-spanish-b2-aguacero-adventure/m34.mp3"),
      message("m35", "laura", "Me encanta. Esa frase sí es bacana: si hay trancón, se toma tintico.", "I love it. That phrase really is cool: if there's traffic, you drink a little coffee.", ["bacano / bacana", "trancón", "tintico"]),
      message("m36", "nico", "Y si alguien anda con el celular afuera, ojo, pilas, no dar papaya.", "And if someone is walking around with their phone out, watch out, be careful, don't make yourself an easy target.", ["celular", "ojo", "pilas", "no dar papaya"]),
      message("m37", "andres", "Listo, profesor Nico. Se la mando ya a mi mamá también: no dar papaya con el celular.", "Okay, Professor Nico. I'll send it to my mom now too: don't make yourself an easy target with your phone.", ["listo", "se la mando ya", "no dar papaya", "celular"]),
      message("n5", "narrator", "Final scene: the group turns the whole mess into a joke, but each joke recycles real Colombian chunks from the lesson.", "Final scene: the group turns the whole mess into a joke, but each joke recycles real Colombian chunks from the lesson.", ["bacano / bacana", "cansón"], "narrator"),
      message("m38", "vale", "Entonces resumen: ¿Qué más?, parce, te cuento una vuelta: un tinto rapidito puede volverse una aventura.", "So summary: what's up, mate, let me tell you something: a quick coffee can turn into an adventure.", ["¿Qué más?", "parce", "te cuento una vuelta", "tinto", "rapidito"]),
      message("m39", "nico", "Resulta que… la aventura empezó con un aguacero, siguió con dos lucas, y acabó con medio mundo en una tiendita.", "It turns out that... the adventure started with a downpour, continued with two thousand pesos, and ended with everyone in a little shop.", ["resulta que…", "aguacero", "dos lucas", "medio mundo", "tiendita"]),
      message("m40", "nico", "Y por lo menos aprendí algo: si me coge la tarde, mando nota de voz; si estoy empapado, busco tintico.", "And at least I learned something: if I end up running late, I send a voice note; if I'm soaked, I look for little coffee.", ["por lo menos", "me cogió la tarde", "nota de voz", "empapado", "tintico"], "voice-note", "/audio/stories/colombian-spanish-b2-aguacero-adventure/m40.mp3"),
      message("m41", "dona-marta", "Y si no tiene efectivo, fresco, no se preocupe; acá somos queridos.", "And if you don't have cash, don't worry, it's fine; here we're kind.", ["en efectivo", "fresco / fresca", "no se preocupe", "querida / querido"]),
      message("m42", "laura", "Doña Marta oficialmente nos hizo el día.", "Doña Marta officially made our day.", ["me hizo el día"]),
      message("m43", "andres", "Aunque el trancón estuvo berraco y la buseta llenísima, la historia quedó buena.", "Even though the traffic was intense and the bus was completely full, the story turned out good.", ["trancón", "berraco", "buseta", "llenísima"]),
      message("m44", "nico", "Sí, fue cansón, pero bacano. Una vuelta muy colombiana.", "Yes, it was annoying, but cool. A very Colombian situation.", ["cansón", "bacano / bacana", "una vuelta"]),
      message("m45", "vale", "Remate oficial: uno sale por un tinto, termina con una aventura, y vuelve hablando como parcero de la tiendita.", "Official ending: you go out for a coffee, end up with an adventure, and come back speaking like the little shop's buddy.", ["rematé diciendo", "uno sale por…", "tinto", "termina con una aventura", "parcero", "tiendita"]),
      message("m46", "vale", "De una. Ahora sí, tranquilos: guarden el celular, pidan otro tintico y esperen mientras escampa.", "Absolutely. Now yes, relax: put away the phone, order another little coffee, and wait while the rain stops.", ["de una", "tranquilos", "celular", "tintico", "mientras escampa"], "voice-note", "/audio/stories/colombian-spanish-b2-aguacero-adventure/m46.mp3"),
    ],
    comprehensionChecks: [
      { id: "check-1", afterMessageId: "m7", question: storyQuestions[0] },
      { id: "check-2", afterMessageId: "m14", question: storyQuestions[1] },
      { id: "check-3", afterMessageId: "m17", question: storyQuestions[2] },
      { id: "check-4", afterMessageId: "m26", question: storyQuestions[3] },
      { id: "check-5", afterMessageId: "m46", question: storyQuestions[4] },
    ],
  ...
  data: {
    ...
    questions: [
      ...
      },
      {
        ...
        nativePrompt: "You go out for a coffee and end up with an adventure.",
        correctAnswer: "tinto",
      ...
      ),
      {
        ...
        nativePrompt: "The thing is we had to wait.",
