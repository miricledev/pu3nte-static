...
export const colombianSpanishB2WhatsAppStory: WhatsAppStory = {
  ...
  data: {
    ...
    messages: [
      message("n1", "narrator", "Scene 1: Nico thinks he is just stepping out for a quick coffee. Listen for how Colombians open a casual story.", "Scene 1: Nico thinks he is just stepping out for a quick coffee. Listen for how Colombians open a casual story.", [], "narrator"),
      ...
      message("m3", "nico", "Resulta que salí por un tintico y se vino un aguacero berraco.", "It turns out I went out for a little coffee and a brutal downpour started.", ["resulta que…", "tintico", "aguacero berraco"], "voice-note"),
      ...
      message("n2", "narrator", "Narrator note: the shop phrases are warm and informal. Notice bien pueda, a la orden, mijo, and ¿me regala...?", "Narrator note: the shop phrases are warm and informal. Notice bien pueda, a la orden, mijo, and ¿me regala...?", ["bien pueda", "a la orden", "mijo / mija", "¿me regala…?"], "narrator"),
      ...
      message("m8", "dona-marta", "Con mucho gusto, querido. Son dos lucas.", "With pleasure, dear. It's two thousand pesos.", ["con mucho gusto", "querida / querido", "dos lucas"], "voice-note"),
      ...
      message("m13", "nico", "La vuelta es que me cogió la tarde y llegué empapado.", "The thing is I ended up running late and arrived soaked.", ["la vuelta es que…", "me cogió la tarde", "empapado"], "voice-note"),
      ...
      message("n3", "narrator", "Scene 2: the story moves from rain into WhatsApp logistics. Listen for ubicación, se la mando ya, ojo, pilas, and no dar papaya.", "Scene 2: the story moves from rain into WhatsApp logistics. Listen for ubicación, se la mando ya, ojo, pilas, and no dar papaya.", ["ubicación", "se la mando ya", "ojo", "pilas", "no dar papaya"], "narrator"),
      ...
      message("m18", "nico", "Listo, se la mando ya. Pero ojo, pilas con el celular en esa esquina.", "Okay, I'll send it now. But watch out, be careful with your phone on that corner.", ["listo", "se la mando ya", "ojo", "pilas", "celular"], "voice-note"),
      ...
      message("m23", "andres", "Yo llegué todo estresado, pero la arepita me hizo el día.", "I arrived really stressed, but the little arepa made my day.", ["todo estresado", "arepita", "me hizo el día"], "voice-note"),
      ...
      message("n4", "narrator", "Final scene: the same phrases come back as a punchline. This repetition is deliberate so the Colombian chunks stick.", "Final scene: the same phrases come back as a punchline. This repetition is deliberate so the Colombian chunks stick.", [], "narrator"),
      ...
      message("m28", "nico", "De una. Ni modo por el trancón, pero por lo menos aprendimos media Colombia en una tarde.", "Absolutely. Oh well about the traffic, but at least we learned half of Colombia in one afternoon.", ["de una", "ni modo", "trancón", "por lo menos"], "voice-note"),
