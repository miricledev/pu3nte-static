...
const storyQuestions: CheckpointQuestion[] = [
  { id: "dominican-b1-gossip-story-q1", type: "multiple-choice", prompt: "How does Junior describe the party at first?", options: ["It started calmly and ended like a soap opera", "It was boring from beginning to end", "It was only about food prices", "It never actually happened"], correctAnswer: "It started calmly and ended like a soap opera", explanation: "Junior says it started tranquilo and terminó como novela.", points: 1, skillTag: "gist" },
