...
const storyQuestions: CheckpointQuestion[] = [
  {
    ...
    options: ["A small black coffee", "A taxi", "A phone charger", "A meeting room"],
    correctAnswer: "A small black coffee",
  ...
  },
  {
    ...
    options: ["She does not have enough money", "She hates coffee", "The shop is closed", "She already paid"],
    correctAnswer: "She does not have enough money",
