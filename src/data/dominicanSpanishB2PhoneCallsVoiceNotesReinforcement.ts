...
export const dominicanSpanishB2PhoneCallsVoiceNotesReading: ReadingComprehension = {
  ...
  data: {
    ...
    paragraphs: [
      {
        id: "p1",
        text: "Dominican phone Spanish is fast, practical, and full of repair phrases. A call might start with “¿Qué tú dices?” and then quickly move to “Dame luz” or “Dime a ver” when someone needs the update. These are casual, friendly ways to say: tell me what is going on.",
        highlights: highlights(["¿Qué tú dices?", "Dame luz", "Dime a ver"]),
        shadowLine: "¿Qué tú dices? Dame luz, dime a ver.",
      },
      {
        id: "p2",
        text: "When the signal is bad, phrases like “¿Tú me oyes bien?”, “te me fuiste”, and “ya te oigo nítido” keep the conversation moving. “Nítido” can mean clear, perfect, or all good, so context matters.",
      ...
      {
        id: "p3",
        text: "If you did not understand something, you can say “¿Cómo fue?”, “no la agarré”, or “esa parte no la agarré”. For a more specific repeat, use “¿Cómo fue que tú dijiste...?” These phrases are less formal than “no entendí”, but very useful in real calls.",
      ...
      {
        id: "p4",
        text: "Dominicans often explain busyness with “estoy en una vuelta”, “estoy resolviendo”, or “tengo un corre-corre”. These phrases show that the person is moving, arranging, or handling something, not simply ignoring the call.",
      ...
      {
        id: "p5",
        text: "For planning, “cuadrar algo”, “déjame cuadrar eso”, and “ahorita te confirmo” are key. They leave space to arrange details. But if the other person needs an answer, they might say “no me dejes en el aire”.",
      ...
      {
        id: "p6",
        text: "Voice notes solve problems when calls fail. You can say “mándame un audio por ahí” or “déjame eso en un audio”. But if the voice note is too long, someone might joke: “me mandaste una película”. In that case, “¿Cuál es el punto?” means: get to the point.",
      ...
      {
        id: "p7",
        text: "To close the conversation, Dominican Spanish uses flexible contact phrases: “tú me avisas”, “cualquier cosa me tiras”, “yo te tiro”, and “quedamos en eso”. Together, they mean the plan is alive, the details are clear enough, and both people know who will update whom.",
