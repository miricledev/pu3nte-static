...
export const dominicanSpanishC1AdvancedSlangNuanceRegisterReading: ReadingComprehension = {
  ...
  data: {
    ...
    paragraphs: [
      {
        id: "p1",
        text: "Advanced Dominican slang is not just vocabulary; it is social judgment. A phrase like “¿Qué es lo que se mueve?” can open a casual conversation, but “no aguanto vaina” is much stronger. It can sound like a hard boundary, frustration, or a warning, depending on tone.",
      ...
      {
        id: "p2",
        text: "Some phrases describe pressure. “Dar carpeta” means someone keeps hassling you, while “plagosear” means pestering or begging in an annoying way. If someone says “no me vengas a plagosear”, the relationship is already tense, so the phrase should not be treated like a neutral request.",
        highlights: highlights(["dar carpeta", "plagosear", "vengas a plagosear"]),
        shadowLine: "No me des carpeta y no me vengas a plagosear.",
      },
      {
        id: "p3",
        text: "Other phrases are about emotional control. “Coger lucha” is stressing yourself out unnecessarily. “Coger cuerda” is taking the bait when someone provokes you. Advice like “no cojas lucha” and “no cojas cuerda” is common because it protects your image as much as your peace.",
        highlights: highlights(["coger lucha", "coger cuerda", "no cojas lucha", "no cojas cuerda"]),
        shadowLine: "No cojas lucha y no cojas cuerda.",
      },
      {
        id: "p4",
        text: "Dominican problem-solving often sounds practical. “Resolver” means making it work, and “buscarle el bajadero” means finding a practical way around the problem. If someone says “le busco el bajadero”, they are not promising perfection; they are promising movement.",
      ...
      {
        id: "p5",
        text: "Money and loyalty have their own slang. “Hacer un serrucho” means people chip in together. “Boronear” or “andar boroneando” means doing small side jobs for extra cash. “Un enllave” is a trusted contact, the kind of person who can connect you to a solution.",
      ...
      {
        id: "p6",
        text: "Boundary phrases are powerful. “Sacar los pies” means to distance yourself or abandon someone. “Soltar en banda” means to cut someone loose. “Subir los vidrios” means tuning someone out completely. These are not light phrases; they describe social distance becoming real.",
      ...
      {
        id: "p7",
        text: "Finally, some phrases judge behavior. “Pasarse de contento” means someone got carried away. “Medalaganario” describes arbitrary behavior with no order or reason. “Armar un rebú” means creating a messy commotion. At C1, the goal is not to use every phrase everywhere; it is to feel how strong each phrase is.",
