import { normalizePunctuation, removeAccents } from "../../utils/answer";
...
function alignTokens(userAnswer: string, correctAnswer: string): DiffPair[] {
...
function SmartAnswerComparison({
  ...
  const pairs = alignTokens(userAnswer, correctAnswer);
  return (
